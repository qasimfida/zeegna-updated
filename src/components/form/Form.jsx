...
const Form = () => {
  ...
  return (
    <form className="bg-[#F7F7F7] select-icon  md:mt-[40px] flex justify-center rounded-[30px] max-sm:rounded-[15px] w-full poppin">
      <div className="md:w-[67%] max-sm:mx-[15px] pt-[44px] max-sm:pt-[20px] flex flex-col justify-center">
        <select
          className="bg-transparent border border-gray-300 rounded-lg !px-4 py-3 h-[50px]	w-full text-gray-600 text-[14px] font-medium"
          defaultValue=""
        >
          <option
        ...
        <div className="flex justify-center mt-[23px] pb-[56px] max-sm:pb-[20px]">

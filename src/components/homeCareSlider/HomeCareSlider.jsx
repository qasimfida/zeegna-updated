      ...
      <section className="gap-[106px] pt-[80px] pl-[90px] pr-[71px] pb-[64px] h-[494px] flex font-poppins bg-[#F7F7F7]">
        ...
        <div className="w-[804px]">
          ...
          <p className="text-[20px] font-medium text-[#5E5E6F] w-[67%]">
            Take our care quiz to find help with daily activities like bathing,
            dressing, meal prep, and companionship. Connect with trusted home
            care agencies to help you and your loved ones age at home safely
            and comfortably.
          </p>
          <div className="flex gap-3 pt-[30px]">
            <button className="border border-black px-[26px] py-[13px] rounded-full hover:bg-black hover:text-white">
              Take our care quiz
            </button>
            <button className="bg-black text-white px-[26px] py-[13px] rounded-full hover:text-black hover:bg-transparent hover:border hover:border-black">

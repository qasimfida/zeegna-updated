...
const HomeCareSlider = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      description:
        "Understand the fundamental aspects of home care and how it can benefit you and your loved ones.",
    },
    {
      title: "Personalized Care Options",
      description:
        "Explore customized care plans tailored to meet individual needs and preferences.",
    },
    {
      title: "Finding Qualified Caregivers",
      description:
        "Learn how to identify and hire qualified caregivers who can provide the best support.",
    },
    {
      title: "Home Safety Solutions",
      description:
        "Discover strategies to make your home safer for elderly individuals and those with disabilities.",
    },
    {
      title: "Transportation Services",
      description:
        "Find reliable transportation options for medical appointments and daily activities.",
    },
    {
      title: "Professional Services Overview",
      description:
        "Get an overview of various professional services available to support home care needs.",
    },
    {
      title: "Legal Considerations in Home Care",
      description:
        "Understand the legal aspects involved in home care, including contracts and caregiver rights.",
    },
    {
      title: "Financial Planning for Home Care",
      description:
        "Explore financial options and resources to help manage the costs of home care services.",
    },
  ];
  return (
    <>

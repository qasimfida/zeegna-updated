          ...
          {selectedOption === "Other" && (
            <div className="flex flex-col mt-[5px]">
              <input
                ...
                className="border border-gray-400 bg-[#F7F7F7] rounded-[10px] 
                text-[16px] text-black font-medium px-4 py-[14px] w-full h-[50px] 
                focus:outline-none max-w-full touch-action-manipulation 

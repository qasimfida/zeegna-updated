  ...
  return (
    <div className="relative w-full sm:w-[90%]">
      ...
      <Swiper
        ...
        className="lg:w-[80%] h-auto lg:h-[60vh] mb-6 mt-3"
      >
        {/* First Slide */}
        <SwiperSlide className="text-center flex flex-col items-center justify-center gap-4">
          ...
          <h2 className="text-lg font-semibold text-wrap w-[63%]">
            We found the perfect caregiver for mom. She's kind and incredibly
            helpful. The process of getting the care my mom needed was simple,
            and now she's happy and well taken care of. It feels wonderful to
            see her content.
          </h2>

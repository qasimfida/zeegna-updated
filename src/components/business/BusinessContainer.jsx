...
const BusinessContainer = ({ title, description, Icon }) => {
  ...
  return (
    <>
      {/* section 1 */}
      <section className="flex justify-center flex-col font-poppins bg-[#F7F7F7] py-[80px] max-sm:py-[50px]">
      ...
      <section className="poppin">
        <div className="sm:mx-20 py-20 mt-20">
          <div className="text-center">
            ...
            <p className="font-medium text-[18px] text-[#5E5E6F] py-4 max-sm:text-[16px]">
      ...
      {/* section 3 */}
      <section>
        <div className="poppin bg-[#F7F7F7]">
        ...
        <div className="flex flex-col md:flex-row items-center bg-[#E8FFF1] rounded-[40px] max-sm:rounded-[30px] px-[20px] md:px-[40px] lg:px-[80px] py-[40px]">
          <div className="flex flex-col justify-between p-4 max-sm:p-0 leading-normal md:w-2/3">
            <div className="lg:w-[430px] max-sm:text-center">
              <h5 className="mb-[20px] max-sm:mb-[10px] text-[27px] max-sm:text-[21px] font-semibold lg:w-[430px]">
                Ready for your next great move?
              </h5>
              <p className="mb-[20px] max-sm:mb-[10px] font-medium text-[18px] max-sm:text-[16px] lg:text-[18px] text-[#5E5E6F]">

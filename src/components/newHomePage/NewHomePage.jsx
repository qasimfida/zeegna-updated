    ...
    <div className="">
      <section className="bg-[#FFFFFF]  poppin ">
        <div className=" mx-auto text-center ">
          <div
            className="flex md:pt-[150px] max-sm:pt-[90px] pl-[29px] pr-[58px]  justify-center relative md:pb-[175px] 
        max-sm:flex-col max-sm:h-auto max-sm:pb-[60px] max-sm:px-[16px] "
          >
            ...
            <div className="text-center max-sm:w-full">
              {/* Heading */}
              <h1 className="text-[64px] xl:leading-[80px] font-semibold text-gray-800 md:mb-5 mb-[10px] max-sm:text-[27px] poppin text-4xl max-lg:text-[48px]">
                Comfort. Choice. Home.
              </h1>

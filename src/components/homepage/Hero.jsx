      ...
      <section className="bg-gradient-to-b from-[#FFFDFD] via-[#FFFDFD] to-[#F7E7E7] poppin ">
        ...
        max-sm:flex-col max-sm:h-auto max-sm:py-[90px] max-sm:px-[16px] max-sm:pb-[20px]"
          >
            ...
            {/* form  */}
            <div className=" py-[30px] bottom-0 max-sm:bottom-[-100%] mb-[-42px] xl:w-[1144px] xl:h-[150px] md:h-[223px] mx-auto bg-white  rounded-3xl shadow-md absolute left-0 right-0 max-sm:py-[30px] max-sm:px-[15px]  flex max-xl:mx-[30px] max-sm:mx-[7px] max-lg:bottom-[-47%]  items-center justify-around  max-md:mb-38">
              <div className="">
                  ...
                  <div className="md:flex gap-[30px] lg:items-end items-center w-full">
                    ...
                    <div>
                      <div className="text-center lg:text-right w-full">
                        <button className="border-2 border-black text-black py-3 px-9 font-medium rounded-full hover:text-white hover:bg-black w-full max-lg:w-[146px] max-sm:w-full max-lg:px-0 max-sm:px-9">
                          Get started
                        </button>
                      </div>
                    </div>

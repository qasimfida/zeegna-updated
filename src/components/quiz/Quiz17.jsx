...
const Quiz17 = () => {
  ...
  return (
    <>
      <div className="md:pl-[26px] pt-[50px] pb-[100px] md:pt-[100px] md:pb-[215px] max-sm:px-[16px] poppin">
        <div className="w-full max-w-[600px]">
          {/* Question Title */}
          <h2 className="md:text-[18px] text-[16px] font-semibold leading-[28px] mb-[15px]">
            Is there anything else you’d like the consultant to know before
            the appointment?
          </h2>

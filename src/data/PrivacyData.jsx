const PrivacyData = [
  {
    id: 1,
    title: "Last Updated: October 14, 2024",
    description: [
      "This Privacy Policy is effective October 14, 2024, for all users.",
    ],
  },
  {
    id: 2,
    title: "",
    description: [
      "This Privacy Policy describes how we collect, use, and share information when you use our Services. The terms “we,” “us,” or “our” mean Zeegna.com, its operating company, parent company, and each of their legal subsidiaries and affiliates. The term “Services” means, collectively, various websites, applications, widgets, email notifications, and other mediums, or portions of such mediums, through which you have accessed this Privacy Policy. By accessing or using our Services, you consent to the collection, transfer, manipulation, storage, disclosure, and other uses of Your Information (collectively, “Use of Your Information”) as described in this Privacy Policy.",
  ...
  {
    id: 4,
    title: "Information We Collect and Receive About You",
    description:[
  ...
  {
    id: 6,
    title: "Information Third Parties Provide",
    description:[
      "We may collect information about you from sources other than you, such as from social media websites (i.e., Facebook, LinkedIn, Twitter, or others), other users, and our business partners.",
  ...
  {
    id: 7,
    title: "General Use and Preference Information",
    description:[
      "We may collect, receive, and store information regarding your general use of our Services (such as details of how and when you used our Services, interactions with our Services, login information, resources that you access, your Internet protocol address, your browser type, and your device type), as well as your preferences.",
    ]
  },
  ...
  {
    id: 11,
    title: "Log Files, Cookies, and Anonymous Identifiers",
    description: [
  ...
  },
  {
    ...
    description: [
      ...
      "-As a referral agent, and in states where applicable (including California and Oregon), Zeegna.com is a mandated reporter of suspected and known elder abuse. As such, Zeegna.com may release your name, phone number, address, and other information you’ve shared with us to the state authorities in cases of suspected or known elder abuse;",
  ...
  {
    id: 16,
    title: "Requests for Quotes, Information, and Services from Service Providers and Consent to Automatic Telephone Dialing System.",
    description: [
  ...
  {
    id: 17,
    title: "Aggregation and De-Personalization",
    description: [
  ...
  },
  {
    ...
    description: [
      "We specifically and expressly reserve the right to disclose, lease, sell, assign or transfer Your Information collected through our Services, and any of our databases, together with any personally identifiable information contained in such databases, to third parties in connection with a Business Transfer. A “Business Transfer” means a share or asset sale, acquisition, merger, consolidation, reorganization, spin-off, bankruptcy, or other corporate change involving us and/or our affiliates, even if the Business Transfer is only being contemplated."
    ]
  },
  {
    id: 20,
    title: "Circumvention of Security Measures",
    description: [
  ...
  },
  {
    ...
    description: [
      ...
      "-Cookies: If you do not wish for us to collect cookies, you may set your browser to refuse cookies, or to alert you when cookies are being sent. If you do so, please note that some parts of our Services may then be inaccessible or may not function properly.",
      ...
      "-Accessing and Correcting Personally Identifiable Information:  If a portion of our Services allows you to create an account with us, you can review and update Your Information by logging into that portion of our Services, visiting your account profile page, and making changes. We will retain Your Information for as long as your account is active or as needed to provide you services and as necessary to comply with our legal obligations, resolve disputes, and enforce our agreements.",
      "-Log Files: Various browsers may offer their own management tools for removing HTML5 Storage LSOs",
      "-Online Behavioral Advertising: Various browsers may offer their own management tools for removing HTML5 Storage LSOs",
  ...
  {
    id: 25,
    title: "Information You Disclose to Third Parties",
    description: [
  ...
  {
    id: 27,
    title: "Third-Party Widgets and Plug-ins",
    description: [
  ...
  {
    id: 28,
    title: "Operation of our Services in the United States",
    description: [
  ...
  },
  {
    ...
    title: "Contacting Us",
    description: [
      "If you have questions or concerns about our privacy practices or wish to make a request regarding Your Information, please contact us at privacy@zeegna.com."
    ]
  },
  {
    id: 31,
    title: "Special Notification for California Residents — Your California Privacy Rights",
    description: [
      "Under the California Consumer Privacy Act of 2018 (“CCPA“), California residents have certain rights around Zeegna’s collection, use, and sharing of their personal information.",
      "Zeegna collects various categories of personal information when you use the Service, including identifiers, commercial information, internet or other electronic network or device activity information, and geolocation data. A more detailed description of the information Zeegna collects and how we use it is provided above in Information We Collect and Receive About You and How We Use Information. Furthermore, the section How We Disclose Information describes the categories of third parties with whom we may share personal information, and what information may be shared under different circumstances.",
      "If you are a resident of California, you have the right to request to know what personal information has been collected about you and to access that information. You also have the right to request the deletion of your personal information, though exceptions under the CCPA may allow Zeegna to retain and use certain personal information notwithstanding your deletion request. You may send your request for access to that information or request deletion by email to privacy@zeegna.com. We will not discriminate against you for exercising your rights under the CCPA. An agent may submit a request on your behalf, but you must verify that your agent is authorized to do so.",
      ...
      "Such requests must be submitted to us at privacy@zeegna.com or in writing at:",
      "Zeegna, LLC",
  ...
  {
    id: 32,
    title: "Special Notification for Oregon Residents — Your Oregon Privacy Rights",
    description: [
      "We will not share your referral information with a senior living facility or marketing affiliate without obtaining affirmative consent from you for each instance of sharing the information. We will not refer you to a facility in which our employees or immediate family members of our employees have an ownership interest. We will not contact you if you request in writing that we stop contacting you. We will provide you access to our records for your referral information within 30 calendar days of your request of those records. We will maintain your records for a minimum of three years after we refer you to senior living communities and are no longer receiving referral services from us.",
      "Separate from the CCPA, California’s Shine the Light law gives California residents the right to ask companies what personal information they share with third parties for those third parties’ direct marketing purposes."
    ]
  },

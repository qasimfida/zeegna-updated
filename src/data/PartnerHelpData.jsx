const PartnerHelpData = [
  ...
  {
    id: 2,
    title: "What types of companies can list their services on Zeegna?",
    description:
      "Zeegna is all about bringing the right care and services to families who need them. If your business helps seniors age at home, we’re here to connect you with families actively searching for the services you offer. Here’s how your business can fit into our platform: Personal care: If you provide home care or home health service",
  },
  {
    id: 3,
    title: "How does joining the Zeegna network benefit service providers?",
    description:
      "Becoming a part of the Zeegna network means more than just listing your services. It’s about joining a platform that is designed to connect you directly with families who are actively seeking care solutions. With the home care market projected to reach $460 billion, there’s an incredible opportunity to expand your business by being part of our trusted provider network",
  },
  {
    id: 4,
    title:
      "How does the application process work to join the Zeegna network?",
    description:
      "The application process to join the Zeegna network is simple and starts online. First, businesses select the type of services they offer, whether it’s personal care, home maintenance, wellness, or other categories. From there, you'll be guided through an application form that captures key details about your business, including service offerings, contact information, and areas of service.",
  },
  {
    id: 5,
    title:
  ...
  },
  {
    ...
    description: "The approval process typically takes between 3 to 5 business days, depending on the volume of applications and the thoroughness of the information you provide. We review each application to ensure that all service providers meet our standards for quality and trustworthiness. You’ll receive an email once your application is approved, and from there, you can begin listing your services.",
  },
];

export default PartnerHelpData;

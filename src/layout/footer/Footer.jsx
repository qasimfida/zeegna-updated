            ...
            <div class="px-4 my-4 w-full xl:w-[550px]">
              ...
              <div>
                <p class="text-justify text-sm	font-medium	text-[#BBBBBB] xl:w-[550px]">
                  ...
                  at home is about preserving dignity, independence, and love.
            ...
            <div className="flex max-sm:mx-[16px] max-sm:w-full">
              <div class="px-4 max-sm:px-0 max-sm:mx-[0px] my-4 w-full sm:w-auto">
                ...
                <ul class="leading-8 max-sm:leading-0 text-base mb-2.5 text-[#BBBBBB] font-medium max-sm:text-[14px]">
                  <li>
                    <Link to="/home-modifications" class="hover:text-white">
                      Home modifications
                    </Link>
                  </li>
                  <li>
                    <Link to="/homes-automation" class="hover:text-white">
                      Home automation
                    </Link>
                  </li>
                  <li>
                    <Link to="/home-maintenance" class="hover:text-white">
                      Home maintenance
                    </Link>
                  </li>
                  <li>
                    <Link to="/homes-safety" class="hover:text-white">
                      Home safety
                    </Link>
                  </li>
                  <li>
                    <Link to="/homes-care" class="hover:text-white">
                      Home care
                    </Link>
                  </li>
                </ul>
              ...
              <div class="px-4 max-sm:px-0 max-sm:mx-[0px] my-4 w-full sm:w-auto">
                ...
                <ul class="leading-8 max-sm:leading-0 text-base mb-2.5 text-[#BBBBBB] font-medium max-sm:text-[14px]">
                  <li>
                    <Link to="/professional-service" class="hover:text-white">
